...
<section class="page-title" style="background-image: url(<?php echo base_url(); ?>others/images/background/page-title.jpg);">
    <div class="auto-container">
        <div class="title-outer">
            <h1 class="title">Country We Serve Australia</h1>
        </div>
    </div>
</section>
...
<?php
foreach($ServeAustralia as $ServeAustraliaData)
{
    $image=$ServeAustraliaData['image'];
    $text=$ServeAustraliaData['text'];
    $string2 = substr($text, 0, 1100);
    $string3 = substr($text, 1100, 25000);
}
?>
