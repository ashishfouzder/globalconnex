...
<div class="sticky-header">
    <div class="auto-container">
        <div class="inner-container">
            <!--Logo-->
            <div class="logo">
                <a href="<?php echo $SiteURLHome; ?>" title=""><img src="<?php echo base_url(); ?>others/images/logo.png" alt="" title=""></a>
            </div>
            <!--Right Col-->
            <div class="nav-outer">
                <!-- Main Menu -->
                    ...
                    <ul class="list-unstyled contact-details__info">
                        <li>
                            ...
                            <div class="text">
                                ...
                                <a href="tel:8801966601743"><span>Free</span> +8801966601743</a>
                            </div>
                        </li>
                        <li>
                            <div class="icon">
                            ...
                            <div class="text">
                                <h6>Write email</h6>
                                <a href="mailto:info@globalconnex.com.au">info@globalconnex.com.au</a>
                            </div>
                        </li>
                        <li>
                            <div class="icon">
                            ...
                            <div class="text">
                                <h6>Visit anytime</h6>
                                <span>131, Wakil Tower, 8th Floor, Gulshan Link Road, Dhaka, Bangladesh</span>
                            </div>
                        </li>
                    </ul>
                </div>
...
<section>
    <div class="container-fluid p-0">
        <div class="row">
            ...
            <iframe src="https://maps.google.com/maps?q=Nikunja 2, Dhaka&t=&z=10&ie=UTF8&iwloc=&output=embed" data-tm-width="100%" height="500" frameborder="0" allowfullscreen=""></iframe>
        </div>
    </div>
</section>
...
<footer class="main-footer">
    ...
    <div class="footer-bottom">
        <div class="auto-container">
            <div class="inner-container">
                <div class="copyright-text">&copy; Copyright 2023 by <a href="#">Global Connex</a></div>
...
<script src="<?php echo base_url(); ?>others/js/jquery-ui.js"></script>
...
<script src="<?php echo base_url(); ?>others/js/swiper.min.js"></script>
