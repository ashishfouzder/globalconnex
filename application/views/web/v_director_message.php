        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-md-12 col-sm-12">
                ...
                <div class="testimonial-block-two mb-md-30">
                    <div class="inner-box">
                        <div class="image-box">
                            <figure class="image"><img src="<?php echo base_url(); ?>others/images/resource/testimonial-4.jpg" alt=""></figure>
                        </div>
            ...
            <div class="col-lg-6 col-md-12 col-sm-12">
                ...
                <div class="testimonial-block-two">
                    <div class="inner-box">
                        <div class="image-box">
                            <figure class="image"><img src="<?php echo base_url(); ?>others/images/resource/testimonial-5.jpg" alt=""></figure>
                        </div>
                        <div class="content-box">
                            <div class="rating"><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i></div>
                            <div class="text">To review means to look back over something for evaluation or memory. It’s always a joy to hear that the work I do has positively impacted our clients.</div>
