...
<section class="page-title" style="background-image: url(<?php echo base_url(); ?>others/images/background/page-title.jpg);">
    <div class="auto-container">
        <div class="title-outer">
            <h1 class="title">Resume&nbsp;Building</h1>
        </div>
    </div>
</section>
<?php
foreach($ResumeBuilding as $ResumeBuildingData)
{
    $image=$ResumeBuildingData['image'];
    $title=$ResumeBuildingData['title'];
    $text=$ResumeBuildingData['text'];
}
