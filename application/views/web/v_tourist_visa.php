...
<?php
foreach($TouristVisa as $TouristVisaData)
{
    $image=$TouristVisaData['image'];
    $title=$TouristVisaData['title'];
    $text=$TouristVisaData['text'];

    $string2 = substr($text, 0, 647);
    $string3 = substr($text, 647, 1500);
}
