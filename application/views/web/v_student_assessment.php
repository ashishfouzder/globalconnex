                ...
                <form id="contact_form" name="contact_form" class="" action="#" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            <div class="mb-3">
                                ...
                                <select class="default-select  form-control wide"  name="MartialStatus" required>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            <div class="mb-3">
                                ...
                                <select class="default-select  form-control wide" name="HighestEducation" required>
                                    <option value="">Choose one</option>
                                    <option value="Inside of Bangladesh">Inside of Bangladesh</option>
                                    <option value="Outside of Bangladesh">Outside of Bangladesh</option>
                                </select>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            <div class="mb-3">
                                <div class="mb-3">
                                    <label class="lebel_title">Select a program for foreign study :</label>
                                    <select class="default-select  form-control wide" name="HighestEducation" required>
                                        <option value="">Choose one</option>
                                        <<option value="Kindergarten">Kindergarten</option>
                                        <option value="Primary">Primary</option>
